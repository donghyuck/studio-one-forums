 ...
 * </pre>
 */
@Component("forumTopicListCacheResolver")
@ConditionalOnBean(CacheManager.class)
public class ForumTopicListCacheResolver implements CacheResolver {
    ...
    public ForumTopicListCacheResolver(CacheManager cacheManager,
    ...
    public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
        ...
        String forumSlug = args[0].toString();
        String cacheName = CacheNames.Topic.listCacheName(forumSlug);
